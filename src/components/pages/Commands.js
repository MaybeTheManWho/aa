...
const commandsData = [
  ...
  },
  {
    id: 11,
    name: '/editcase',
    description: 'Modifies a specific moderation action',
    usage: '/editcase [case#]',
    category: 'moderation',
    parameters: [
      {
        name: 'case#',
        description: 'The case number to modify',
        required: true
      }
    ]
  },
  {
    ...
    parameters: [
      ...
      {
        name: 'reason',
        description: 'Reason for the unmute (not always necessary)',
        required: false
      }
    ]
  },
  ...
  },
  {
    id: 17,
    name: '/Stats',
    description: 'View the total amount of tier tests a tester has completed',
    usage: '/Stats',
    category: 'testing'
  },
  {
  ...
  },
  {
    id: 20,
    name: '/Exempt',
    description: 'Prevents a ticket from getting automatically closed after 40 minutes of inactivity',
    usage: '/Exempt',
    category: 'testing'
  },
  {
    id: 21,
    name: '/Stop',
    description: 'Marks yourself as "Unavailable" after you finish testing or ends the testing session',
    usage: '/Stop',
    category: 'testing'
  },
  {
